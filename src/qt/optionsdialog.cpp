        ...
        QWidget(parent)
{
    ...
    bitcoin_at_startup = new QCheckBox(tr("&Start I0coin on window system startup"));
    bitcoin_at_startup->setToolTip(tr("Automatically start I0coin after the computer is turned on"));
    ...
    map_port_upnp->setToolTip(tr("Automatically open the I0coin client port on the router. This only works when your router supports UPnP and it is enabled."));
        ...
        QWidget(parent)
{
    ...
    display_addresses->setToolTip(tr("Whether to show I0coin addresses in the transaction list"));
